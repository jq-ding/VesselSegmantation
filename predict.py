...
from extract_patches import con_threshold
from extract_patches import con_threshold_otsu
# pre_processing.py
...
con_threshold(pred_imgs)
threshold_confusion = con_threshold_otsu(pred_imgs, nbins=256)
...
for i in range(int(N_predicted/group)):
    ...
    visualize(pred_stripe, path_experiment + name_experiment + "Prediction" + str(i))  # .show()
